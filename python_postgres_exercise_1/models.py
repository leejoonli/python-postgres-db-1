...
class JobHistory(models.Model):
    ...
    job = models.ForeignKey(Job, on_delete=models.CASCADE, related_name='job_histories')
    department = models.ForeignKey(Department, on_delete=models.CASCADE, related_name='job_histories')

    def __str__(self):
        return (f'{self.employee}, {self.department}, {self.job}')